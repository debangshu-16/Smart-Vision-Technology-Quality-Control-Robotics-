The OCR and Barcode Scanner model extracts text information such as product names, expiration dates, and barcodes from the images. This helps verify packaging labels for quality control.
## Steps to Run:
